-- UH Tender Finder - full initial schema
...
-- RLS. Tender intelligence is available only to approved members.
...
-- Members can update only non-privileged preferences through this RPC.
-- There is deliberately NO general profiles UPDATE policy, preventing self-approval or self-admin escalation.
...
create policy "Approved members read eligible tenders" on public.tenders for select to authenticated using((public.is_approved_member() and supply_only_status='eligible') or public.is_admin());
...
-- Seed merchant relevance taxonomy. CPV prefixes are deliberately broad; keyword scoring narrows the match.
insert into public.tender_taxonomy(category,rule_type,value,weight) values
('Building Materials','cpv_prefix','4411',35),('Building Materials','cpv_prefix','4410',25),('Building Materials','keyword','building materials',35),('Building Materials','keyword','cement',15),('Building Materials','keyword','mortar',15),('Building Materials','keyword','plywood',15),('Building Materials','keyword','mdf',15),
('Timber','cpv_prefix','0341',35),('Timber','keyword','timber',35),('Timber','keyword','wood products',20),('Timber','keyword','sheet material',15),
('Insulation','keyword','insulation',40),('Insulation','keyword','insulating materials',35),('Insulation','keyword','mineral wool',20),
('Plumbing','cpv_prefix','4416',25),('Plumbing','keyword','plumbing',40),('Plumbing','keyword','pipe fittings',25),('Plumbing','keyword','valves',15),('Plumbing','keyword','copper tube',25),
('Heating','cpv_prefix','4462',30),('Heating','keyword','heating equipment',35),('Heating','keyword','boiler',30),('Heating','keyword','radiator',25),('Heating','keyword','heating controls',20),
...
('Drainage & Civils','keyword','drainage',35),('Drainage & Civils','keyword','manhole',20),('Drainage & Civils','keyword','soil pipe',20),('Drainage & Civils','keyword','civil engineering materials',25),
('Roofing','keyword','roofing materials',40),('Roofing','keyword','roof tiles',25),('Roofing','keyword','roofing membrane',25),
...
('Hardware & Fixings','cpv_prefix','4452',30),('Hardware & Fixings','keyword','fasteners',30),('Hardware & Fixings','keyword','fixings',30),('Hardware & Fixings','keyword','nuts bolts screws',25),
...
('Paint & Decorating','cpv_prefix','4481',35),('Paint & Decorating','keyword','paint',25),('Paint & Decorating','keyword','decorating supplies',30),('Paint & Decorating','keyword','rollers',10),
('PPE & Workwear','cpv_prefix','181',25),('PPE & Workwear','cpv_prefix','351134',35),('PPE & Workwear','keyword','ppe',30),('PPE & Workwear','keyword','workwear',30),('PPE & Workwear','keyword','protective clothing',25),
...
('Electrical & Lighting','cpv_prefix','312',25),('Electrical & Lighting','cpv_prefix','315',25),('Electrical & Lighting','keyword','electrical supplies',35),('Electrical & Lighting','keyword','lighting',25),('Electrical & Lighting','keyword','cable',15),
...
('General Merchant','exclude_keyword','software',30),('General Merchant','exclude_keyword','consultancy',45),('General Merchant','exclude_keyword','catering',30),('General Merchant','exclude_keyword','medical',35),('General Merchant','exclude_keyword','pharmaceutical',45)
